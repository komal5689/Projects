...
def getWeather():
    ...
    long_lat.config(text=f"{round(location.latitude,4)}°N, {(location.longitude,4)}°E")
    ...
    api="https://api.openweathermap.org/data/2.5/onecall?lat="+str(location.latitude)+"&lon="+str(location.longitude)+"&units=metric&exclude=hourly&appid=008132dc375033e64f7a3751566fe058"
...
'''background image'''
img=Image.open('./ggb.png')
img=img.resize((900,500),Image.ANTIALIAS)
img_photo=ImageTk.PhotoImage(img)

bg_lbl=tk.Label(root,image=img_photo)
bg_lbl.place(x=0,y=0,width=900,height=400)

heading_title=tk.Label(bg_lbl,text='Earth including over 200,000 cities!',fg='white',bg='#2952a3',font=('times new roman',23,'bold'))
heading_title.place(x=210,y=8)
...
Label(root,image=Round_box,bg="#2952a3").place(x=30,y=110)

'''label'''
label1=Label(root,text="Temperature",font=('Helvetica',11),fg="white",bg="#203243")
label1.place(x=50,y=120)

label2=Label(root,text="Humdity",font=('Helvetica',11),fg="white",bg="#203243")
...
'''search_box'''
Serach_image=PhotoImage(file="Images/Rounded Rectangle 3.png")
myimage=Label(image=Serach_image,bg="#2952a3")
...
'''bottom box'''
frame=Frame(root,width=900,height=180,bg="white")
...
'''clock(herewe will place time)'''
clock=Label(root,font=("helvetica",20,'bold'),fg='white',bg="#2952a3")
clock.place(x=25,y=25)

'''timezone'''
timezone=Label(root,font=('helvetica',20),fg='white',bg="#2952a3")
timezone.place(x=700,y=25)

long_lat=Label(root,font=('helvetica',10),fg='white',bg="#2952a3")
